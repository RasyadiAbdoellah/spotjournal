...
var config = {
  apiOrigins: {
    production: 'https://spotscout.herokuapp.com',
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div data-id=\""
    ...
    + "\" class=\"entry panel panel-default\">\n    <div class=\"panel-heading\">\n      <div class=\"row\">\n        <div class=\"col-xs-6 col-sm-8 col-md-10\">\n          <h3 class=\"panel-title\"><strong>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</strong></h3>\n        </div>\n"
    + ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"data-controls","hash":{"place":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "      </div>\n    </div>\n\n    <div class=\"panel-body\">\n      <div>\n        <h4><strong>Address:</strong>\n        "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.address : stack1), depth0))
    ...
    + ((stack1 = container.invokePartial(__webpack_require__(37),depth0,{"name":"data-forms","hash":{"place":blockParams[0][0]},"data":data,"blockParams":blockParams,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "      </div>\n    </div>\n  </div>\n\n";
  ...
  return "            <strong>Description: </strong>\n              <p class=\"well description\">"
    ...
    return "\n  <div class=\"entry row\">\n    <h3>No places saved. Add a place by clicking the '+' and filling out the details.</h3>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.places : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.program(6, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var store = __webpack_require__(3);
var showPlacesTemplate = __webpack_require__(8);

var sortPlacesAscending = function sortPlacesAscending(a, b) {
  return a.id - b.id;
};

var modifyMessageBox = function modifyMessageBox(divId, text, htmlClass) {
  $(divId).text(text);
  $(divId).removeClass().addClass(htmlClass).slideDown(200).delay(3500).slideUp(200);
};

var getPlacesSuccess = function getPlacesSuccess(data) {
  var placeArray = data.places.sort(sortPlacesAscending);
  var showPlaces = showPlacesTemplate({ places: placeArray });

  $('#content').html(showPlaces);
};

var createPlaceSuccess = function createPlaceSuccess(data) {
  $('#new-name').val('');
  $('#new-address').val('');
  $('#new-descrip').val('');
};
...
module.exports = {
  ...
  getPlacesSuccess: getPlacesSuccess,
  updatePlaceSuccess: updatePlaceSuccess,
  deletePlaceSuccess: deletePlaceSuccess,
  createPlaceFail: createPlaceFail,
  updatePlaceFail: updatePlaceFail,
  getPlacesFail: getPlacesFail,
  deletePlaceFail: deletePlaceFail
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var setAPIOrigin = __webpack_require__(15);
var config = __webpack_require__(4);
var authEvents = __webpack_require__(17);
var placesEvents = __webpack_require__(38);

$(function () {
  setAPIOrigin(location, config);

  authEvents.addHandler();
  placesEvents.addHandler();
});
...
var parseNestedQuery = __webpack_require__(16);
...
var toggleSignInSignUp = function toggleSignInSignUp() {
...
var addHandler = function addHandler(event) {
...
var store = __webpack_require__(3);
var showPlacesTemplate = __webpack_require__(8);
var placesApi = __webpack_require__(10);
var placesUi = __webpack_require__(11);
...
var onSignInSuccess = function onSignInSuccess(data) {
  ...
  placesApi.getPlaces().then(placesUi.getPlacesSuccess);
};
...
var onSignUpFailure = function onSignUpFailure(error) {
  var statusCode = error.status.toString();
...
var onChangePassFailure = function onChangePassFailure(error) {
  var statusCode = error.status.toString();
  // display failure messages
  if (statusCode.startsWith('4')) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"data-control btn-group text-right col-xs-6 col-sm-4 col-md-2\">\n    <button type=\"button\" class=\"btn btn-default btn-xs modify\" aria-label=\"Modify\" data-toggle=\"collapse\" data-target=\"#update-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "-collapse\" aria-expanded=\"false\" aria-controls=\"#update-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "-container\">\n      Modify\n    </button>\n    <button type=\"button\" class=\"btn btn-danger btn-xs delete\" aria-label=\"Delete\">\n      Delete\n    </button>\n</div> ";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div id=\"update-"
    ...
    + "-container\">\n    <form id=\"update-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" class=\"update-place form-horizontal\">\n    <div class=\"form-group\">\n      <label class=\"col-xs-2 control-label\" for=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "-name\">Name:</label>\n      <div class=\"col-xs-10\">\n      <input id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "-name\"  class=\"col-xs-10 form-control\" type=\"text\" name=\"place[name]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.name : stack1), depth0))
    + "\" required>\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label class=\"col-xs-2 control-label\" for=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "-address\">Address:</label>\n      <div class=\"col-xs-10\">\n      <input id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "-address\" class=\"col-xs-10 form-control\" type=\"text\" name=\"place[address]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.address : stack1), depth0))
    + "\" required>\n      </div>\n    </div>\n<div class=\"form-group\">\n<label class=\"col-sm-2 control-label\" for=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "-descrip\">Description:</label>\n<div class=\"col-sm-10\">\n<textarea id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.id : stack1), depth0))
    + "-descrip\" name=\"place[description]\" class=\"form-control\" rows=\"3\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.place : depth0)) != null ? stack1.description : stack1), depth0))
...
var onCreatePlace = function onCreatePlace(event) {
  ...
  var data = getFormFields(event.target);
  api.createPlace(data).then(ui.createPlaceSuccess).then(api.getPlaces).then(ui.getPlacesSuccess).then($('#new-place-modal').modal('hide')).catch(ui.createPlaceFail);
};

var getDataEntryId = function getDataEntryId(target) {
...
var onUpdatePlace = function onUpdatePlace(event) {
  ...
  var id = getDataEntryId(event.target);
  var data = getFormFields(event.target);
  // console.log(data)
  ...
  .then(ui.updatePlaceSuccess).then(api.getPlaces).then(ui.getPlacesSuccess).catch(ui.updatePlaceFail);
};

var onGetPlaces = function onGetPlaces(event) {
  event.preventDefault();
  // console.log('get places triggered')
  api.getPlaces().then(ui.getPlacesSuccess).catch(ui.getPlacesFail);
};
...
var onDeletePlace = function onDeletePlace(event) {
  ...
  api.deletePlace(id).then(ui.deletePlaceSuccess).then(api.getPlaces).then(ui.getPlacesSuccess).catch(ui.deletePlaceFail);
};
